...
resource "azurerm_storage_account" "example" {
  name                     = "storageaccountnamemmouyart"
...
resource "azurerm_storage_account" "sg2" {
 name      =  "csestologsmmouyart" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
 resource_group_name   =  var.rg_name
 location     =  var.location
...
name    =  "sqlservermmouyart" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
